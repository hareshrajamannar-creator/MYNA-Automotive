...
const FILTER_FIELDS: FilterField[] = [
  ...
  { id: 'channel',  label: 'Channel',  options: opts('Voice', 'SMS', 'Email') },
      ...
      <div className="flex flex-1 flex-col overflow-auto bg-surface">
        ...
        <div className="flex flex-col gap-lg p-2xl">
          ...
          <div className="grid grid-cols-2 gap-lg">
            <HCCard title="Appointment confirmation by channel" titleSuffix={<InfoTooltip text="Shows the channel that sent the last reminder resulting in a confirmed appointment. Each conversation is counted once." />}>
              <ChartStatRow stats={[
            ...
            <HCCard title="Reminders sent vs confirmed" titleSuffix={<InfoTooltip text="Compares the total reminders sent to the number of appointments confirmed. Each appointment is counted once, regardless of how many reminders were sent." />}>
              <StackedBarChart
                data={REMINDERS_DATA}
