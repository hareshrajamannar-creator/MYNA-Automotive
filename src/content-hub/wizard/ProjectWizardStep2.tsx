    ...
    <div className="flex flex-col gap-6 p-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        {refUrls.length > 0 && (
          <div className="flex flex-col gap-1">
            {refUrls.map((url, i) => (
              <div key={i} className="flex items-center gap-2 px-2 py-2 rounded-md bg-muted text-[12px]">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className={cn(
          ...
          <p className="text-[13px] text-foreground">Drop files or click to browse</p>
      ...
      <div className="flex flex-col gap-2">
        ...
        {DATA_SOURCES.map(src => (
          <div key={src.id} className="flex items-center gap-2 p-4 border border-border rounded-lg bg-background">
            <button
              type="button"
            ...
            <div>
              <p className="text-[13px] text-foreground">{src.label}</p>
