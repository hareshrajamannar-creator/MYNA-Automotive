...
const _SEED_TOOLS = [
  ...
  },
  {
    ...
    name: 'Patient lookup',
    icon: 'person_search',
    description: 'Searches patient by phone + DOB.',
    category: 'Healthcare',
    modules: ['Front desk', 'Conversation'],
    products: ['healthcare'],
    fields: [
      {
        id: 'pl-phone',
        ...
        required: true,
        valueType: 'llm',
        llmDescription: 'Phone number given by the caller.',
      },
      {
        id: 'pl-business_number',
        type: 'paramConfig',
      ...
      },
      {
        ...
        required: false,
        valueType: 'llm',
        llmDescription: 'Email ID of the patient.',
      },
      {
        id: 'pl-patientDob',
        type: 'paramConfig',
        identifier: 'patientDob',
        dataType: 'String',
        required: true,
        valueType: 'llm',
        llmDescription: 'DOB of the patient.',
      },
    ],
    inputs: [
      { name: 'phone', type: 'string' },
      { name: 'business_number', type: 'string' },
      { name: 'country_code', type: 'string' },
      { name: 'emailId', type: 'string' },
      { name: 'patientDob', type: 'string' },
    ],
    outputs: [{ name: 'patient', type: 'object', description: 'Matched patient record or null' }],
  },
];
